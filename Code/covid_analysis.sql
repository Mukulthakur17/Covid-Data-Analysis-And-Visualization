...
-- SHOWING PERCENTAGE OF TOTAL PEOPLE THAT GOT VACCINATED USING THE TABLE OBTAINED IN PREVIOUS QUERY
-- USING CTE TO PERFORM THE CALCULATION PARTITION BY DATA
